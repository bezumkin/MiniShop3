...
use ModxPro\MiniShop3\Model\msCustomerProfile;
...
switch ($modx->event->name) {
    ...
    case 'OnLoadWebDocument':
        ...
        if ($modx->resource->get('class_key') === msProduct::class) {
            if ($dataMeta = $modx->getFieldMeta(msProductData::class)) {
                unset($dataMeta['id']);
