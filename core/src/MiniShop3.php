...
use ModxPro\MiniShop3\Controllers\Options\Options;
...
use ModxPro\MiniShop3\Utils\ExtraFields;
use ModxPro\MiniShop3\Utils\Format;
use ModxPro\MiniShop3\Utils\Plugins;
use ModxPro\MiniShop3\Utils\Services;
...
class MiniShop3
{
    public const NAME = 'MiniShop3';
    public const NAMESPACE = 'minishop3';
    public const PACKAGE = 'modx-pro/minishop3';
    ...
    {
        // Enable custom resource classes
        $this->modx->addPackage('ModxPro\MiniShop3\Model', MODX_CORE_PATH . 'components/minishop3/src/', null, 'ModxPro\\MiniShop3\\');
        // $this->modx->addPackage('ModxPro\MiniShop3\Controllers', MODX_CORE_PATH . 'components/minishop3/src/', null, 'ModxPro\\MiniShop3\\');

        $this->extraFields->loadMap();
        if ($this->pdoFetch && method_exists($this->pdoFetch, 'makePlaceholders')) {
