ms3.grid.OrderProducts = function (config) {
    ...
    Ext.applyIf(config, {
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Order\\Product\\GetList',
...
Ext.extend(ms3.grid.OrderProducts, ms3.grid.Default, {
                ...
                success: {
                    fn: function (r) {
                        ...
                        w = MODx.load({
                            ...
                            record: r.object,
                            action: 'ModxPro\\MiniShop3\\Processors\\Order\\Product\\Create',
                            listeners: {
                                success: {
                                    fn: function () {
    ...
    updateOrderProduct: function (btn, e, row) {
        ...
        MODx.Ajax.request({
            url: ms3.config.connector_url,
            params: {
                action: 'ModxPro\\MiniShop3\\Processors\\Order\\Product\\Get',
                id: id
            },
            listeners: {
                success: {
                    fn: function (r) {
                        ...
                        w = MODx.load({
                            ...
                            id: 'ms3-window-orderproduct-update',
                            record: r.object,
                            action: 'ModxPro\\MiniShop3\\Processors\\Order\\Product\\Update',
                            listeners: {
                                success: {
                                    fn: function () {
                                        ms3.grid.Orders.changed = true;
    ...
    removeOrderProduct: function () {
        ...
        MODx.msg.confirm({
            ...
            url: ms3.config.connector_url,
            params: {
                action: 'ModxPro\\MiniShop3\\Processors\\Order\\Product\\Remove',
