ms3.window.CreateOption = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        width: 800,
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Settings\\Option\\Create',
        },
    });
...
ms3.window.UpdateOption = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Settings\\Option\\Update',
        }
    });
...
ms3.window.AssignOptions = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        width: 600,
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Settings\\Option\\Multiple',
            method: 'assign',
        }
    });
