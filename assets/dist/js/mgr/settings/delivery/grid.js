ms3.grid.Delivery = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        ddAction: 'ModxPro\\MiniShop3\\Processors\\Settings\\Delivery\\Sort',
        enableDragDrop: true,
        multi_select: true,
    });
...
Ext.extend(ms3.grid.Delivery, ms3.grid.Default, {
    ...
    deliveryAction: function (method) {
        ...
        MODx.Ajax.request({
            ...
            params: {
                action: 'ModxPro\\MiniShop3\\Processors\\Settings\\Delivery\\Multiple',
                method: method,
    ...
    updateDelivery: function (btn, e, row) {
        ...
        MODx.Ajax.request({
            url: this.config.url,
            params: {
                action: 'ModxPro\\MiniShop3\\Processors\\Settings\\Delivery\\Get',
                id: id
            },
            listeners: {
                success: {
