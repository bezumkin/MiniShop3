ms3.grid.ExtraField = function (config) {
    ...
    Ext.applyIf(config, {
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Utilities\\ExtraField\\GetList'
        },
        stateful: true,
        stateId: config.id,
        multi_select: true,
...
Ext.extend(ms3.grid.ExtraField, ms3.grid.Default, {
    ...
    extraFieldAction: function (method) {
        ...
        MODx.Ajax.request({
            ...
            params: {
                action: 'ModxPro\\MiniShop3\\Processors\\Utilities\\ExtraField\\Multiple',
                method: method,
    ...
    updateExtraField: function (btn, e, row) {
        ...
        MODx.Ajax.request({
            url: this.config.url,
            params: {
                action: 'ModxPro\\MiniShop3\\Processors\\Utilities\\ExtraField\\Get',
                id: id
            },
            listeners: {
                success: {
