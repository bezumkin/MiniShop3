...
ms3.combo.User = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\System\\User\\GetList',
            combo: true,
        },
...
ms3.combo.Category = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        url: ms3.config.connector_url,
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Category\\GetCats',
            combo: true,
            id: config.value
        },
        tpl: new Ext.XTemplate('\
...
ms3.combo.Autocomplete = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        allowBlank: true,
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Product\\Autocomplete',
            name: config.name,
            combo: true,
            limit: 0
        },
...
ms3.combo.Vendor = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        forceSelection: false,
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Settings\\Vendor\\GetList',
            combo: true,
            id: config.value,
        }
    });
...
ms3.combo.Options = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        store: new Ext.data.JsonStore({
            ...
            url: ms3.config.connector_url,
            baseParams: {
                action: 'ModxPro\\MiniShop3\\Processors\\Product\\GetOptions',
                key: config.name
            }
        }),
    mode: 'remote',
...
ms3.combo.Chunk = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        url: ms3.config.connector_url,
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\System\\Element\\Chunk\\GetList',
            mode: 'chunks'
        },
        tpl: new Ext.XTemplate(
            '\
...
ms3.combo.Resource = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        url: ms3.config.connector_url,
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\System\\Element\\Resource\\GetList',
            combo: true
        }
    });
...
ms3.combo.Context = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        url: ms3.config.connector_url,
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\System\\Element\\Context\\GetList',
            combo: true
        }
    });
...
ms3.combo.Status = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        url: ms3.config.connector_url,
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Settings\\Status\\GetList',
            combo: true,
...
ms3.combo.Delivery = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        url: ms3.config.connector_url,
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Settings\\Delivery\\GetList',
            combo: true
        },
        listeners: ms3.combo.listeners_disable
    });
...
ms3.combo.Payment = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        url: ms3.config.connector_url,
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Settings\\Payment\\GetList',
            combo: true,
...
ms3.combo.Link = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        url: ms3.config.connector_url,
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Settings\\Link\\GetList',
            combo: true
        }
    });
...
ms3.combo.Product = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        url: ms3.config.connector_url,
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Product\\GetList',
            combo: true,
            id: config.value
        },
        tpl: new Ext.XTemplate('\
...
ms3.combo.ExtraOptions = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        url: ms3.config.connector_url,
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Settings\\Option\\GetList',
        },
...
ms3.combo.OptionTypes = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        url: ms3.config.connector_url,
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Settings\\Option\\GetTypes',
        },
        allowBlank: false,
        editable: true
    });
...
ms3.combo.Classes = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        url: ms3.config.connector_url,
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Settings\\GetClass',
            type: config.type || '',
        },
        allowBlank: true,
        editable: true,
...
ms3.combo.ModCategory = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Settings\\Option\\GetCategories',
            combo: true,
            id: config.value,
        }
    });
