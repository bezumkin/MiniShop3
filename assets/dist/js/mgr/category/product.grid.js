ms3.grid.Products = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        stateful: true,
        stateId: config.id,
        save_action: 'ModxPro\\MiniShop3\\Processors\\Product\\UpdateFromGrid',
        autosave: true,
        save_callback: this.updateRow,
        ddGroup: 'ms-products',
        ddAction: 'ModxPro\\MiniShop3\\Processors\\Product\\Sort',
        enableDragDrop: true,
        defaultNotify: false
    });
...
Ext.extend(ms3.grid.Products, ms3.grid.Default, {
    ...
    productAction: function (method) {
        ...
        MODx.Ajax.request({
            ...
            params: {
                action: 'ModxPro\\MiniShop3\\Processors\\Product\\Multiple',
                method: method,
    ...
    createProduct: function () {
        MODx.loadPage('resource/create', 'class_key=ModxPro\\MiniShop3\\Model\\msProduct&parent=' + MODx.request.id + '&context_key=' + MODx.ctx);
    },

    createCategory: function () {
        MODx.loadPage('resource/create', 'class_key=ModxPro\\MiniShop3\\Model\\msCategory&parent=' + MODx.request.id + '&context_key=' + MODx.ctx);
    },
    ...
    generatePreview: function(){
        ...
        MODx.Ajax.request({
            url: ms3.config.connector_url,
            params: {
                action: 'ModxPro\\MiniShop3\\Processors\\Gallery\\Multiple',
                method: 'GenerateAll',
                ids: Ext.util.JSON.encode(ids),
            },
            listeners: {
