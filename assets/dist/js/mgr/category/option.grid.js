ms3.grid.CategoryOption = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Category\\Option\\GetList',
        ...
        stateId: config.id,
        autosave: true,
        save_action: 'ModxPro\\MiniShop3\\Processors\\Category\\Option\\UpdateFromGrid',
...
Ext.extend(ms3.grid.CategoryOption, ms3.grid.Default, {
    ...
    optionAction: function (method) {
        ...
        MODx.Ajax.request({
            ...
            params: {
                action: 'ModxPro\\MiniShop3\\Processors\\Category\\Option\\Multiple',
                method: method,
