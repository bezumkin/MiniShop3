...
ms3.view.Images = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        id: 'ms3-gallery-images-view',
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Gallery\\GetList',
            product_id: config.product_id,
            parent: 0,
            type: 'image',
...
Ext.extend(ms3.view.Images, MODx.DataView, {
    ...
    onSort: function (o) {
        ...
        MODx.Ajax.request({
            url: ms3.config.connector_url,
            params: {
                action: 'ModxPro\\MiniShop3\\Processors\\Gallery\\Sort',
            ...
            function (val) {
                if (val == 'yes') {
                    ...
                    MODx.Ajax.request({
                        url: ms3.config.connector_url,
                        params: {
                            action: 'ModxPro\\MiniShop3\\Processors\\Gallery\\RemoveAll',
            ...
            function (val) {
                if (val == 'yes') {
                    ...
                    MODx.Ajax.request({
                        url: ms3.config.connector_url,
                        params: {
                            action: 'ModxPro\\MiniShop3\\Processors\\Gallery\\GenerateAll',
                            product_id: product_id,
                        },
                        listeners: {
                            success: {
