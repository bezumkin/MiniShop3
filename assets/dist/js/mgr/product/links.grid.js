ms3.grid.ProductLinks = function (config) {
    ...
    Ext.applyIf(config, {
        ...
        baseParams: {
            action: 'ModxPro\\MiniShop3\\Processors\\Product\\ProductLink\\GetList',
...
Ext.extend(ms3.grid.ProductLinks, ms3.grid.Default, {
    ...
    createLink: function (btn, e) {
        ...
        w = MODx.load({
            ...
            baseParams: {
                action: 'ModxPro\\MiniShop3\\Processors\\Product\\ProductLink\\Create',
    ...
    linkAction: function (method) {
        ...
        MODx.Ajax.request({
            url: this.config.url,
            params: {
                action: 'ModxPro\\MiniShop3\\Processors\\Product\\ProductLink\\Multiple',
                method: method,
